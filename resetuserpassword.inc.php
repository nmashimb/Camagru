...
if (isset($_POST['newpswd']) && isset($_POST['newpswdconf']) && isset($_POST['sub']))
    {
        ...
        {
            header("Location: ../Camagru/resetpassword.inc.php?useremail=$email&token=$vkey&passwordchange=fail");
            exit();
        }
        ...
        {
            header("Location: ../Camagru/resetpassword.inc.php?useremail=$email&token=$vkey&passwordchange=failed");
            exit();
        }
